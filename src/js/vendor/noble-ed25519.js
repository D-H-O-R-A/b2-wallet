...
// Wrap export to support both Node.js (CommonJS) and browser environment (global window.noble)
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { etc, getPublicKey, getPublicKeyAsync, hash, hashes, keygen, keygenAsync, Point, sign, signAsync, utils, verify, verifyAsync };
} else {
    globalThis.noble = globalThis.noble || {};
    globalThis.noble.ed25519 = { etc, getPublicKey, getPublicKeyAsync, hash, hashes, keygen, keygenAsync, Point, sign, signAsync, utils, verify, verifyAsync };
}
