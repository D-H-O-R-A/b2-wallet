/**
 * B2 Wallet - Módulo de Eventos Globais, Listeners de UI e Onboarding de B2WalletApp.
 */

B2WalletApp.prototype.getRandomIndices = function(count, max) {
    const indices = [];
...
B2WalletApp.prototype.completeWalletCreation = async function(password, pin) {
    try {
...
B2WalletApp.prototype.setupAppEventListeners = function() {
    // ----------------------------------------------------------------
